<%-- 
    Document   : seguridad
    Created on : 25 nov 2024, 6:11:26 p.m.
    Author     : Miguel
--%>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="#" class="account-option">
                    <span>Añade una foto de perfil para personalizar tu cuenta</span>
                ...
                <div class="account-option">
                    <span>Telefono de recuperacion</span>
                    <span>
                ...
                <div class="account-option">
                    <span>Correo de recuperacion</span>
                    <span>
                        <%=cuenta.getCorreo()%>
                    </span>
                </div>
